...
- Automatically create NAT rules on a fronting Organization Edge (vShield Edge Gateway).
...
- Permission checks, make sure you have at least Catalog Admin privileges if you want to upload boxes to vCloud Director.
- Thorough testing.
...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider :vcloud do |vcloud|
    ...
    # (Optional) - Use only if network vdc_network_name connects to an Edge Gateway
